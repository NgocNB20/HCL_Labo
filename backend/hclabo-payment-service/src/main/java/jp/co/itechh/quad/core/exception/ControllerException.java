...
public class ControllerException extends AppLevelException {
    ...
    /**
     * FacesMessage.SEVERITY_ERRORと引数messageCodeからControllerExceptionを作成
     *
    ...
    /**
     * 引数 severity, messageCode, args からControllerExceptionを作成
     *
    ...
    /**
     * 引数 severity, messageCode, args, cause からControllerExceptionを作成
     *
     * @param severity      エラーレベル
     * @param messageCode   メッセージコード
     * @param args          メッセージ引数
