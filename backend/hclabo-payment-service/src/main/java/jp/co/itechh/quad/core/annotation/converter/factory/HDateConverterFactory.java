...
import jp.co.itechh.quad.core.annotation.converter.HCDate;
import jp.co.itechh.quad.core.annotation.converter.impl.HDateConverterImpl;
...
/**
 * <span class="logicName">【日付変換】</span>日付コンバータのアノテーションファクトリクラス
 *
 * @author kimura
 */
