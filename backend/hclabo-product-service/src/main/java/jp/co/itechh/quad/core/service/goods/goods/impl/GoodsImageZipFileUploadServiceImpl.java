...
public class GoodsImageZipFileUploadServiceImpl extends AbstractShopService implements GoodsImageZipFileUploadService {
     ...
     */
    @Override
    public int execute(String uploadedFileUrl) {
        return execute(uploadedFileUrl, null);
    }
     ...
     */
    @Override
    public int execute(String uploadedFileUrl, String zipImageTarget) {
        // パラメータのチェック
        ...
        try {
            ...
            File file = new File(uploadedFileUrl);
            fileList = unzipUtility.unzip(file, imageFilePath, true);
