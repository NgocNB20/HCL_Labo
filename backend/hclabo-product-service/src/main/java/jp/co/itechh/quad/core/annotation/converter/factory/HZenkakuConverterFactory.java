...
import jp.co.itechh.quad.core.annotation.converter.HCZenkaku;
import jp.co.itechh.quad.core.annotation.converter.impl.HZenkakuConverterImpl;
...
/**
 * <span class="logicName">【全角変換】</span>全角コンバータのアノテーションファクトリクラス
 *
 * @author kimura
 */
