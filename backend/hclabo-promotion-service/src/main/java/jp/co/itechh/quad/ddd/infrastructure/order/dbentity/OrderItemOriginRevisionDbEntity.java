...
/**
 * 改訂用注文商品DbEntityクラス<br/>
 *
 * @author Pham Quang Dieu (VTI Japan Co., Ltd.)
 */
@Entity
@Table(name = "OrderItemOriginRevision")
@Data
@Component
@Scope("prototype")
public class OrderItemOriginRevisionDbEntity implements Serializable {
    ...
    @SequenceGenerator(sequence = "orderitemoriginrevision_id_seq")
    private Long id;
