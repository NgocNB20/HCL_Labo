...
public class DateUtility {
    ...
    /**
     * yyyyMMddフォーマット文字列を指定日付フォーマットに変換
     * yyyyMMddにマッチしない場合はnullを返す
     *
     ...
     * @return 変換後の日付。無効な引数を受け取った場合 null
     */
    ...
    /**
     *
     * 指定フォーマット形式の文字列をTimestamp型に変換して返します。
     *
    ...
    /**
     * 指定された日時が現在日時よりも未来であるかどうかを判定します。
     *
     * @param time 指定日時
    ...
    /**
     * 指定された日が現在日時よりも過去日時であるかどうかを判定します。
     *
     * @param time 指定日時
    ...
    /**
     * 指定された日が現在<b>日</b>よりも過去<b>日</b>であるかどうかを判定します。
     *
     * @param date 指定日
    ...
    /**
     * 指定された期間の最初日時、最終日時のマップを取得する
     * <ul>
     * 引数：DateUtility#TERM_TODAY、DateUtility#TERM_YESTERDAY、DateUtility#TERM_THIS_MONTH、DateUtility#TERM_LAST_MONTH
