...
@EnableAsync
public class PricePlanningServiceApplication {

    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(PricePlanningServiceApplication.class);
