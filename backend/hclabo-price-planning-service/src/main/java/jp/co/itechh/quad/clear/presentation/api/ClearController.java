...
import jp.co.itechh.quad.ddd.usecase.sales.DeleteSalesSlipUseCase;
 ...
 */
@RestController
public class ClearController implements PricePlanningApi {
    ...
    /** 販売伝票削除ユースケース */
    private final DeleteSalesSlipUseCase deleteSalesSlipUseCase;
     ...
     * @param deleteSalesSlipUseCase                  販売伝票削除ユースケース
     */
    @Autowired
    public ClearController(MessagePublisherService messagePublisherService,
                           HeaderParamsUtility headerParamsUtil,
                           DeleteSalesSlipUseCase deleteSalesSlipUseCase) {
        this.messagePublisherService = messagePublisherService;
        this.headerParamsUtil = headerParamsUtil;
        this.deleteSalesSlipUseCase = deleteSalesSlipUseCase;
    }

    /**
     * POST /price-planning/clear : クリアバッチ
     * クリアバッチ
     *
    ...
    /**
     * DELETE /price-planning/cancellation : 不要販売伝票取消
     * 不要販売伝票取消
     *
     * @param unnecessarySalesSlipCancellationRequest 不要販売伝票取消リクエスト (required)
     ...
     */
    @Override
    public ResponseEntity<Void> delete(@NotNull @Valid UnnecessarySalesSlipCancellationRequest unnecessarySalesSlipCancellationRequest) {

        // 不要データ削除処理
        deleteSalesSlipUseCase.deleteUnnecessaryByTransactionId(
                        unnecessarySalesSlipCancellationRequest.getTransactionId());
