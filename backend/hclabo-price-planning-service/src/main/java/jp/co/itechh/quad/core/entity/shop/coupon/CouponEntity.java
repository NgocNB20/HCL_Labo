...
package jp.co.itechh.quad.core.entity.shop.coupon;
...
public class CouponEntity implements Serializable {
    ...
    private HTypeDiscountType discountType;
    ...
    /** 対象商品制限種別 */
    @Column(name = "targetGoodsType")
    private HTypeCouponTargetType targetGoodsType;
    ...
    /** 対象会員制限種別 */
    @Column(name = "targetMembersType")
    private HTypeCouponTargetType targetMembersType;
