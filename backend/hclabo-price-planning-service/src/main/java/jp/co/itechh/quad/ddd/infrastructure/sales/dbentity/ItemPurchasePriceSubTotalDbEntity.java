...
/**
 * 商品購入価格小計 DbEntityクラス
 *
 * @author Pham Quang Dieu (VTI Japan Co., Ltd.)
 */
@Entity
@Table(name = "ItemPurchasePriceSubTotal")
@Data
@Component
@Scope("prototype")
public class ItemPurchasePriceSubTotalDbEntity implements Serializable {
    ...
    @SequenceGenerator(sequence = "itempurchasepricesubtotal_id_seq")
    private Long id;
