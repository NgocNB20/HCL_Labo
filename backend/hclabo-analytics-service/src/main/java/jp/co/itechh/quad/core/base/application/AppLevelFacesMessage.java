...
package jp.co.itechh.quad.core.base.application;
...
public class AppLevelFacesMessage extends FacesMessage {
    ...
    /**
     * SeverityをERRORとし、AppLevelFacesMessageを作成する
     */
    ...
    /**
     * SeverityをERRORとし、引数のsummayでAppLevelFacesMessageを作成する
     *
    ...
    /**
     * SeverityをERRORとし、引数のsummay,detailでAppLevelFacesMessageを作成する
     *
     * @param summary メッセージ概要
    ...
    /**
     * 引数のseverity,summary,detailからAppLevelFacesMessageを作成する
     *
    ...
    /**
     * FacesMessageからAppLevelFacesMessageを作成する
     *
    ...
    /**
     * 引数facesMessage, messageCode, argsからAppLevelFacesMessageを作成する
     *
     * @param facesMessage FacesMessageオブジェクト
