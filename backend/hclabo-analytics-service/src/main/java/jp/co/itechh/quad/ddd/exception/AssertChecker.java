...
public class AssertChecker {
     ...
     * @param message
     * @param obj
     * @throws AssertException <code>null</code>の場合。
     */
     ...
     * @param message
     * @param s
     * @throws AssertException 文字列が空あるいは<code>null</code>の場合。
     */
     ...
     * @param message
     * @param c
     * @throws AssertException コレクションが空あるいは<code>null</code>の場合。
     */
     ...
     * @param message
     * @param num
     * @throws AssertException <code>int</code>が負の場合。
     */
