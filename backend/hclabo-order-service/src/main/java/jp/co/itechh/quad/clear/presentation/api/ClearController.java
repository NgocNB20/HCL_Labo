 ...
 */
@RestController
public class ClearController implements OrderApi {
     ...
     */
    @Autowired
    public ClearController(MessagePublisherService messagePublisherService, HeaderParamsUtility headerParamsUtil) {
        this.messagePublisherService = messagePublisherService;
        this.headerParamsUtil = headerParamsUtil;
    }

    /**
     * POST /order/clear : クリアバッチ
     * クリアバッチ
     *
     ...
     */
    @Override
    public ResponseEntity<BatchExecuteResponse> execute(@Valid ClearBatchRequest clearBatchRequest) {
        // ルーティングキー取得
        ...
        try {
            ...
            LOGGER.error(HTypeBatchName.BATCH_CLEAR.getLabel() + messageLogParam + e.getMessage());
