...
@Component
@Scope("prototype")
public class SettlementAdministratorErrorProcessor {

    /** ロガー */
    private static final Logger LOGGER = LoggerFactory.getLogger(SettlementAdministratorErrorProcessor.class);
     ...
     */
    public void processor(SettlementAdministratorErrorMailRequest settlementAdministratorErrorMailRequest) {
        try {
            ...
            valueMap.put("RESULT", settlementAdministratorErrorMailRequest.getErrorResultMsg());
            ...
            mailDto.setMailTemplateType(HTypeMailTemplateType.SETTLEMENT_ADMINISTRATOR_ERROR_MAIL);
