...
import jp.co.itechh.quad.core.constant.type.HTypeShipmentCompleteMail;
...
public class ShipmentNotificationProcessor {
     ...
     * メール送信
     *
     * @param request 出荷完了メール送信リクエスト
     */
    public void processor(ShipmentNotificationRequest request) {
     ...
     */
    protected void sendMail(ShipmentNotificationRequest request, MailTemplateEntity entity) {
