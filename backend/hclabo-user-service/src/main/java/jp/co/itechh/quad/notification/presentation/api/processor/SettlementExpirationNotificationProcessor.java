...
@Component
@Scope("prototype")
public class SettlementExpirationNotificationProcessor {
     ...
     * メール送信
     *
     * @param request 受注決済期限切れメール送信リクエスト
     */
    public void processor(SettlementExpirationNotificationRequest request) {
    ...
    protected MailDto createMailDtoCommon() {
        ...
        MailTemplateEntity entity =
                        mailTemplateDao.getEntityByType(1001, HTypeMailTemplateType.SETTLEMENT_EXPIRATION_NOTIFICATION);
