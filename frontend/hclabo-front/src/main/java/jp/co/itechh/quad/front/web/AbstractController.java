...
import jp.co.itechh.quad.front.base.application.FacesMessage;
...
import jp.co.itechh.quad.front.exception.ControllerException;
...
public abstract class AbstractController {
    ...
    /**
     * リダイレクトアトリビュートに保持されているメッセージの取得
     *
     * @param redirectAttributes リダイレクトアトリビュート
     * @return HIT-MALLメッセージ
     */
    protected static HmMessages getFlashMessages(RedirectAttributes redirectAttributes) {
     ...
     * @param redirectAttributes redirectAttributes
     */
    protected void handleClientErrorWithRedirectAttributes(String responseBody,
                                                           BindingResult bindingResult,
                                                           Map<String, String> itemNameAdjust,
                                                           RedirectAttributes redirectAttributes) {
        ConversionUtility conversionUtility = ApplicationContextUtility.getBean(ConversionUtility.class);
        ...
        // メッセージリストの件数分ループ
        HmMessages allMessages = new HmMessages();
        for (AppLevelException e : getErrorList()) {
