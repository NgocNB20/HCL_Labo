...
public class DateUtility {
    ...
    /**
     * 日付フォーマット yyyyMMddに変換
     *
     * @param date 日付
     * @return 日付フォーマット yyyyMMdd
     */
    public String convertToStringYMD(Date date) {
        if (date == null) {
            return null;
        }
     ...
     * @return 曜日
     */
    public String getFormatMdWithWeek(Timestamp timestamp) {
     ...
     * @return 曜日
     */
    public String getDayOfTheWeek(Timestamp timestamp) {
