...
public class AnnotationMetaDataProvider implements MetaDataProvider {
    ...
    private List<ConstraintDescriptorImpl<?>> findConstraints(Constrainable constrainable, JavaBeanAnnotatedElement annotatedElement,
        ...
        // HIT-MALL4 customize from here
        Annotation[] annotations = jp.co.itechh.quad.front.annotation.validator.util.DynamicValidatorAnnotationUtil
                        .getAnnotations(constrainable, annotatedElement, kind);
        // HIT-MALL4 customize to here
