...
public class HeaderParamsHelper {
    ...
    /* APIクライアント取得メソッド */
    private static final String METHOD_GET_API_CLIENT = "getApiClient";
    ...
    /* APIキー */
    private static final String API_KEY_AUTHENTICATION = "XLoggedInAdminSeq";

    /* Beanファクトリー */
    private final ConfigurableListableBeanFactory beanFactory;

    /* 会員APIキー */
    public static final String API_KEY_AUTHENTICATION_MEMBER = "XLoggedInMemberSeq";
     ...
     */
    public void setAdminSeq(String administratorSeq) {
    ...
    /**
     * ヘッダーにCustomerIdを設定する
     *
     * @param apiClient  Object
     * @param customerId 会員SEQ
     */
    public void setHeader(Object apiClient, String customerId) {
        try {
            if (StringUtils.isNotEmpty(customerId)) {
                ...
                Method getAuthentication =
                                apiClient.getClass().getDeclaredMethod(METHOD_GET_AUTHENTICATION, String.class);
                Object apiKeyAuth = getAuthentication.invoke(apiClient, API_KEY_AUTHENTICATION_MEMBER);
