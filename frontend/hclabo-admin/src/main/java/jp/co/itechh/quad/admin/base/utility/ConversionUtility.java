...
package jp.co.itechh.quad.admin.base.utility;
...
import jp.co.itechh.quad.admin.base.util.seasar.DateConversionUtil;
import jp.co.itechh.quad.admin.base.util.seasar.DoubleConversionUtil;
...
public class ConversionUtility {
    ...
    /**
     * String⇒TimeStamp変換<br/>
     *
     * @param targetStr 日時
     * @return Timestamp
     */
    public Timestamp toTimestamp(String targetStr) {
        Timestamp timestamp = null;
        String pattern = "yyyy-MM-dd hh:mm:ss.SSS";

        try {
            Date date = new SimpleDateFormat(pattern).parse(targetStr);
     ...
     * @return 変換後の値（yyyy/MM/dd HH:mm:ss）
     */
    public String toYmdHms(Date value) {
        if (value == null) {
            return "";
        }
        return toYmd(value) + " " + toHms(value);
     ...
     * @return 変換後の値（yyyy/MM/dd）
     */
    public String toYmd(Date value) {
     ...
     * @return 変換後の値（HH:mm:ss）
     */
    public String toHms(Date value) {
     ...
     * @return 変換後の値（[0]:yyyy、[1]:MM、[2]:dd）
     */
    public String[] toYmdArray(Date value) {
     ...
     * @return Date型
     */
    public Date toDate(String value, String dateFormat) {
        Date date = new Date();
        try {
     ...
     * @return the boolean
     */
    public boolean convertFlagToBoolean(String flag) {
